...
function slugify(text, fallback = '') {
    ...
    let slug = transliterateSlugify(text, { lowercase: true, separator: '-' });
...
async function createAndProcessTranslation({ articleId, language, originalArticle }) {
    ...
    try {
        ...
        const initialTranslationData = {
            ...
            publishedAt: originalArticle.publishedAt, // Copy publishedAt from original article
        ...
        await prisma.articleTranslation.update({
            ...
            data: {
                ...
                publishedAt: originalArticle.publishedAt, // Ensure publishedAt is preserved from original
                updatedAt: new Date(),
            },
        });
